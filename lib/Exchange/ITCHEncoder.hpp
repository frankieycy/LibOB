...
public:
    ...
    struct ITCHSystemMessage : public ITCHMessage {
        ...
        static const MessageType ourType = MessageType::SYSTEM;
    ...
    struct ITCHOrderAddWithMPIDMessage : public ITCHOrderAddMessage {
        ...
        virtual std::string toString() const;
        static const MessageType ourType = MessageType::ORDER_ADD_WITH_MPID;
        static const std::string ourDescription;
    ...
    struct ITCHOrderExecuteMessage : public ITCHMessage {
        ...
        virtual std::string toString() const;
        static const MessageType ourType = MessageType::ORDER_EXECUTE;
        static const std::string ourDescription;
        uint64_t orderId;
    ...
    struct ITCHOrderExecuteWithPriceMessage : public ITCHOrderExecuteMessage {
        ...
        virtual std::string toString() const;
        static const MessageType ourType = MessageType::ORDER_EXECUTE_WITH_PRICE;
        static const std::string ourDescription;
        uint32_t fillPrice;
    };
    ...
    struct ITCHOrderDeleteMessage : public ITCHMessage {
        ...
        virtual std::string toString() const;
        static const MessageType ourType = MessageType::ORDER_DELETE;
        static const std::string ourDescription;
        uint64_t orderId;
    };
    ...
    struct ITCHOrderCancelMessage : public ITCHOrderDeleteMessage {
        ...
        virtual std::string toString() const;
        static const MessageType ourType = MessageType::ORDER_CANCEL;
        static const std::string ourDescription;
    ...
    struct ITCHOrderReplaceMessage : public ITCHMessage {
        ...
        virtual std::string toString() const;
        static const MessageType ourType = MessageType::ORDER_REPLACE;
        static const std::string ourDescription;
        uint64_t oldOrderId;
        uint64_t newOrderId;
        uint32_t quantity;
    ...
    struct ITCHTradeMessage : public ITCHOrderExecuteWithPriceMessage {
        ...
        virtual std::string toString() const;
        static const MessageType ourType = MessageType::TRADE;
        static const std::string ourDescription;
    };
    ...
    struct ITCHCrossTradeMessage : public ITCHMessage {
        ...
        virtual std::string toString() const;
        static const MessageType ourType = MessageType::CROSS_TRADE;
        static const std::string ourDescription;
    };
    ...
    struct ITCHBrokenTradeMessage : public ITCHMessage {
        ...
        virtual std::string toString() const;
        static const MessageType ourType = MessageType::BROKEN_TRADE;
        static const std::string ourDescription;
    };
